...
module.exports = MathExtensions.min
module.exports = MathExtensions.max
module.exports = MathExtensions.abs
module.exports = MathExtensions.pow
module.exports = MathExtensions.round
module.exports = MathExtensions.trunc
module.exports = MathExtensions.dec
module.exports = MathExtensions
console.log(MathExtensions.pow(2, 2))
